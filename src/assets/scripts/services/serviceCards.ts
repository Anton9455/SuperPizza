...
const cards = new Map([
    [0, [
        ...
        { id: 3, title: "Для семьи", subtitle: "Сочный сет для всей семьи: две пиццы - Фирменная «Толстое тесто» 40 см, Барбекю с халапеньо 30 см и классическая бутылочка Pepsi 1л." },
        ...
        { id: 5, title: "#Хватитнавсех", subtitle: "Большой сет из пяти пицц 40 см, которого точно хватит на всех: Венеция, Капричоза, Пепперони, Толстое тесто и Четыре Сыра." },
    ...
    [1, [
        ...
        { id: 12, title: "Толстое тесто", subtitle: "ветчина, сервелат, шампиньоны, помидоры, сыр Моцарелла, соус Маджорио" },
